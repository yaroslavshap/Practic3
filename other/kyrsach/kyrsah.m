...
Kr = 0;                   %¬клад рандома в рассто€ние между €чейками
...
for j=1:NSells
    ...
    u = (xu).^2+sin(yu);                            %значение функции в соседних €чейках
    u0 = 0;                                       %значение функции в центральной €чейке
    ax_ex = 0;                                    %точное значение x компоненты градиента 
    ay_ex = 1;                                    %точное значение y компоненты градиента
    xu(N+1) = xu(1);                              
    yu(N+1) = yu(1);
